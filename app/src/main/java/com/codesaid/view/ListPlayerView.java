...
import com.codesaid.exoplayer.IPlayerListener;
 ...
 * 列表视频播放专用
 */
public class ListPlayerView extends FrameLayout implements IPlayerListener, PlayerControlView.VisibilityListener, Player.EventListener {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        pageListPlay.mPlayerControlView.show();
    ...
    public void inActive() {
        ...
        PageListPlay pageListPlay = PageListPlayManager.get(mCategory);
        if (pageListPlay.mExoPlayer == null || pageListPlay.mPlayerControlView == null || pageListPlay.mExoPlayer == null)
            return;
        pageListPlay.mExoPlayer.setPlayWhenReady(false);
        pageListPlay.mPlayerControlView.setVisibilityListener(null);
