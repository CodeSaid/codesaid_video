...
import com.codesaid.view.FullScreenPlayerView;
...
public class ViewZoomBehavior extends CoordinatorLayout.Behavior<FullScreenPlayerView> {
    ...
    public ViewZoomBehavior(Context context, AttributeSet attributeSet) {
        ...
        minHeight = typedArray.getDimensionPixelOffset(R.styleable.view_zoom_behavior_min_height, PixUtils.dp2pix(200));
        typedArray.recycle();
